...
const rawData = [
  ...
  { id: "22-2", side: 'right', ...ROLES.nannan, zh: "$\lceil$然后去快餐厅吃汉堡包，", th: "แล้วก็ไปกินแฮมเบอร์เกอร์ที่ร้านฟาสต์ฟู้ด" },
  ...
  { id: "32", side: 'right', ...ROLES.nannan, zh: "一班加油，小龙加油，", th: "ห้อง 1 สู้ ๆ！เสี่ยวหลง สู้ ๆ！" },
